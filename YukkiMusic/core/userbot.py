...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("ppblb")
                await self.one.join_chat("NO1BROS")
                await self.one.join_chat("ssxhh")
            except:
                pass
            assistants.append(1)
            try:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("ppblb")
                await self.two.join_chat("NO1BROS")
                await self.two.join_chat("ssxhh")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("NO1BROS")
                await self.three.join_chat("ppblb")
                await self.three.join_chat("ssxhh")
            except:
                pass
            assistants.append(3)
            try:
